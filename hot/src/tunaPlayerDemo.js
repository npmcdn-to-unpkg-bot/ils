...
export default class App extends Component {
    constructor (props) {
        ...
        this.state = {
            ...
            audioContext: null,
            song:"James Brown - Funky Drummer",
            songs: [],
            selectArr: [
                {value: "James Brown - Funky Drummer", label: "James Brown - Funky Drummer"},
                {value: "James Brown - Funky Drummer", label: "James Brown - Funky Drummer"},
                {value: "No point of selecting songs", label: "No point of selecting songs"},
                {value: "as this is just a demo", label: "as this is just a demo"},
                {value: "But the desktop version allows that", label: "But the desktop version allows that"}
        ],
            index: 0,
            flagLoop: false,
            duration: null,
    ...
    componentDidMount() {
        this.log("Change some settings to see how TunaPlayer works", 6)
        setTimeout(()=>{this.log("Press the CHECK icon to confirm the changes", 6)}, 6200)
        setTimeout(()=>{this.log("Now you should hear the modified 'Funky Drummer'", 4)}, 12400)
        J.emitter.on("init", ()=>{
            let flagLoop = true
            let duration
    ...
    <div>
        ...
        <div style={cssHalfHeight} className="tile is-ancestor is-marginless is-fullwidth">
            ...
            <div className="tile is-2 is-vertical is-parent">
                <div style={marginlessTuna} className="has-text-centered">
                    CHORUS
                </div>
                <div style={marginlessTuna} className="tile is-child box">
                    <label>Feedback
