            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 3:
                        ...
                        _context.next = 7;
                        return findOneSkipCondition(rand, condition);
...
var randomCondition = function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2() {
        var condition = arguments.length <= 0 || arguments[0] === undefined ? "this.imageSrc===undefined" : arguments[0];
        var willReturn, rand;
    ...
    return function randomCondition(_x) {
...
function countCondition(condition) {
    return new Promise(function (resolve) {
        var model = mongoose.model("Main");
        model.count({ $where: condition }).exec(function (err, count) {
            resolve(count);
        });
    });
}
function findOneSkip() {
    var skipValue = arguments.length <= 0 || arguments[0] === undefined ? 0 : arguments[0];

    return new Promise(function (resolve) {
        var model = mongoose.model("Main");
        model.findOne().skip(skipValue).exec(function (err, result) {
            resolve(result);
        });
    });
}
function findOneSkipCondition() {
    ...
    return new Promise(function (resolve) {
        var model = mongoose.model("Main");
        model.model(modelName).findOne({ $where: condition }).skip(skipValue).exec(function (err, result) {
            resolve(result);
        });
    });
}
function counter() {
    return new Promise(function (resolve) {
        var model = mongoose.model("Main");
        model.model("Counter").find({}, function (error, incoming) {
