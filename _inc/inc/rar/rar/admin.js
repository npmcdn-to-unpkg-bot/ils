$(document).ready(function () {
    ...
    //--||--||--||--||--||--||--||--||-|
    //SOCKET FUNCTIONS
    function textareaSocket(getDataUrl, socketWord, postObject) {
        initMain()
    ...
    $('.reversoDetoen').click(function () {
        var ss = whichField();
        textareaSocket('socks/reverso/detoen','reverso/detoen', {query: ss})
    });
