...
var Hello = function (_React$Component) {
	...
	_createClass(Hello, [{
		...
		value: function componentDidMount() {
			var self = this;
			PubSub.subscribe("just", function (msg, data) {
				self.setState({
					dataIs: data
				});
				ipcRenderer.send('open', msg);
		...
		value: function render() {
			var self = this;
			return React.createElement("div", null, self.state.dataIs);
		}
	}]);
...
ReactDOM.render(React.createElement(Hello, null), document.getElementById('reactContainer'));

},{"pubsub-js":160,"react":158,"react-dom":2}],160:[function(require,module,exports){
/*
